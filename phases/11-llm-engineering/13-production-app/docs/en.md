...
- [mlabonne LLM Engineer -- Deploying LLMs](https://github.com/mlabonne/llm-course#7-deploying-llms) -- the four deployment tiers (local, demo, server, edge) with links to Gradio, Streamlit, vLLM, TGI, SkyPilot, and MLC LLM; the complement to this lesson's FastAPI-native capstone
- [Stas ML Engineering -- Inference Frameworks](https://github.com/stas00/ml-engineering/tree/master/inference#inference-frameworks) -- side-by-side notes on vLLM, TGI, TensorRT-LLM, SGLang, LMDeploy, and MLC-LLM plus a "how to choose" checklist; read before picking a serving layer
- [Stas ML Engineering -- How to choose an inference framework](https://github.com/stas00/ml-engineering/tree/master/inference#how-to-choose-an-inference-framework) -- the decision rubric for matching framework to workload (latency vs throughput, hardware, quant support)
- [Hamel Husain -- Optimizing Latency: TGI vs vLLM vs CTranslate2 vs mlc](https://hamel.dev/notes/llm/inference/03_inference.html) -- measured comparison of throughput and latency across the main serving frameworks; the empirical companion to Stas' qualitative notes
